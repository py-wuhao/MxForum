...
class User(BaseModel):
    ...
    nick_name = CharField(max_length=16, null=True, verbose_name="昵称")
    head_url = CharField(max_length=128, null=True, verbose_name="头像")
    address = CharField(max_length=32, null=True, verbose_name="地址")
    desc = TextField(null=True, verbose_name="个人简介")
    gender = CharField(max_length=8, choices=GENDERS, null=True, verbose_name="性别")
